...
class Pairing(Base, TimestampMixin):
    ...
    def __str__(self) -> str:
        return f"<pairing id={self.id}, page_id={self.page_id}, target_page_id={self.target_page_id}, threshold={self.threshold}, metadata={self.metadata}>"
